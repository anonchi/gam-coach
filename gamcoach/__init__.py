...
GAM Coach also provides an easy-to-use interface that empowers end-users to easily specify their preferences and interactively fine-tune recourse plans. You can try out the GAM Coach UI on [the public demo website](https://anonchi.github.io/gam-coach/), or watch [a demo video](https://youtu.be/Z2vdqZFKNeg).

<iframe width="560" height="315" src="https://www.youtube.com/embed/Z2vdqZFKNeg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
1. The ML model is at [`ebm.js`](https://github.com/anonchi/gam-coach/blob/master/gamcoach-ui/src/ebm/ebm.js) and [`ebmLocal.js`](https://github.com/anonchi/gam-coach/blob/master/gamcoach-ui/src/ebm/ebmLocal.js).
    1. [`ebm.js`](https://github.com/anonchi/gam-coach/blob/master/gamcoach-ui/src/ebm/ebm.js) implements the EBM inference in JavsScript.
    2. [`ebmLocal.js`](https://github.com/anonchi/gam-coach/blob/master/gamcoach-ui/src/ebm/ebmLocal.js) extends the [`ebm.js`](https://github.com/anonchi/gam-coach/blob/master/gamcoach-ui/src/ebm/ebm.js) object to store a data sample where the users want to generate CFs
1. The recourse generation algorithm is at [`gamcoach.js`](https://github.com/anonchi/gam-coach/blob/master/gamcoach-ui/src/ebm/gamcoach.js).

We made the extra effort to create a lightweight [demo website](https://anonchi.github.io/gam-coach) for GAM Coach, which is serverless and runs entirely in the client’s browser. To do that, we **re-implemented** the GAM inference and integer programming optimization using JavaScript and [WebAssembly](https://webassembly.org). In contrast, to implement your own `Model`, you can replace our GAM and integer programming code with a backend server that directly calls your ML models and recourse algorithms in your favorite languages and packages (e.g., Python, R, C++, Scikit-learn).
